...
export default function CreditNotes() {
  ...
  const creditNotes = [
    { id: "CN-001", date: "2024-01-16", customer: "ABC Company", amount: 5000, reason: "Product return", status: "approved" },
    { id: "CN-002", date: "2024-01-19", customer: "XYZ Corporation", amount: 3000, reason: "Price adjustment", status: "draft" },
  ];
