...
export default function Accounting() {
  ...
  const accountingModules = [
    {
      title: "Expenses & COGS",
      description: "Record expenses, COGS (Cost of Goods Sold), and other financial entries",
      icon: TrendingDown,
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Expenses & Other</h1>
        <p className="text-muted-foreground mt-2">
          Manage your expenses, COGS, and financial records
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {accountingModules.map((module) => (
          <Card 
            key={module.path} 
            className={`hover:shadow-lg transition-shadow cursor-pointer ${module.highlight ? 'ring-2 ring-primary/20' : ''}`} 
